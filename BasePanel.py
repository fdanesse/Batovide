...
class BasePanel(gtk.HPaned):
    ...
    def __set_introspeccion(self, widget, view, estructura):
        ...
        self.infonotebook.set_introspeccion(nombre,
            buffer.get_text(inicio, fin, 0), view, "python")
        ...
        if accion == "Nuevo Proyecto":
            ...
            if nueveoproyecto:
                ...
                if self.proyecto:
                    ...
                    # de uno existente
                    if nueveoproyecto["nombre"] in os.listdir(BatovideWorkSpace):
                        return
    ...
    def __abrir_proyecto(self, widget, archivo):
        ...
        if not proyecto.get("main", False):
            return
        if not os.path.exists(os.path.join(proyecto["path"], proyecto["main"])):
            return
